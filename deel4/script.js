...
var part4 = {
    ...
    instruction1: function () {
        ...
        var result = "Student " + student.name + " zit in groep " + student.group + " en zijn eerste les is " + student.lesson[1];
    ...
    instruction2: function () {
        ...
        var jsonPrint = JSON.stringify(studentsArray) ;
        var arrayPrint = "";
